...
def test_create_summary(test_app_with_db, monkeypatch):
    def mock_generate_summary(summary_id, url):  # NOQA: U100
        return None
...
def test_read_summary(test_app, monkeypatch):
    ...
    async def mock_get(id):  # NOQA: U100
        return test_data
...
def test_remove_summary(test_app, monkeypatch):
    ...
    async def mock_delete(id):  # NOQA: U100
        return id
...
def test_update_summary(test_app, monkeypatch):
    ...
    async def mock_put(id, payload):  # NOQA: U100
